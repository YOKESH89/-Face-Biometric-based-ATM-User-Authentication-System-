...
class BankUi:
    def __init__(self,root):
        self.root = root
        self.header = Label(self.root,text="AAAC Bank of India",bg="#00688B",fg="white",font=("times new roman",20,"bold"))
        self.header.pack(fill=X)
        self.frame = Frame(self.root,bg="#00688B",width=900,height=500)
        root.geometry("800x500")
        self.label1 = Label(self.frame, text="Welcome To AAAC Bank", bg="#00688B", fg="white", font=("times new roman",30,"bold"))
    ...
    def get_embeddings(self):
        ...
        ap.add_argument("-i", "--datasets", required=True,
        ...
        detector = cv2.dnn.readNetFromCaffe(r'face_detection_model/deploy.prototxt.txt', r'face_detection_model/res10_300x300_ssd_iter_140000.caffemodel')
    ...
    def video_check(self):
        model_path = r'C:\Users\YOKESH V\Desktop\new\nn4.small2.v1.t7'
        try:
        ...
        detector = cv2.dnn.readNetFromCaffe('face_detection_model//deploy.prototxt.txt', 'face_detection_model//res10_300x300_ssd_iter_140000.caffemodel')
        #summary
        # load our serialized face embedding model from disk
        print("[INFO] loading face recognizer...")
        embedder= cv2.dnn.readNetFromTorch('C:\\Users\\YOKESH V\\OneDrive\\Desktop\\new\\output\\nn4.small2.v1.t7')
